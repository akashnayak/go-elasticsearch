...
ifdef race
	...
	$(eval testapiargs += "-cover" "-coverpkg=github.com/akashnayak/go-elasticsearch/v8/esapi" "-coverprofile=$(PWD)/tmp/integration-api.cov" "-tags='integration'" "-timeout=1h")
ifdef flavor
else
	$(eval flavor='free')
endif
...
lint:  ## Run lint on the package
	...
	go vet github.com/akashnayak/go-elasticsearch/...
	go list github.com/akashnayak/go-elasticsearch/... | 'grep' -v internal | xargs golint -set_exit_status
	@{ \
		set -e ; \
...
godoc: ## Display documentation for the package
	...
	@echo "* http://localhost:6060/pkg/github.com/akashnayak/go-elasticsearch/v8"
	@echo "* http://localhost:6060/pkg/github.com/akashnayak/go-elasticsearch/v8/esapi"
	@echo "* http://localhost:6060/pkg/github.com/akashnayak/go-elasticsearch/v8/estransport"
	@echo "* http://localhost:6060/pkg/github.com/akashnayak/go-elasticsearch/v8/esutil"
	@printf "\n"
