...
[![GoDoc](https://godoc.org/github.com/akashnayak/go-elasticsearch?status.svg)](https://pkg.go.dev/github.com/akashnayak/go-elasticsearch/v8)
[![Go Report Card](https://goreportcard.com/badge/github.com/akashnayak/go-elasticsearch)](https://goreportcard.com/report/github.com/akashnayak/go-elasticsearch)
...
[![Build](https://github.com/akashnayak/go-elasticsearch/workflows/Build/badge.svg)](https://github.com/akashnayak/go-elasticsearch/actions?query=branch%3Amaster)
[![Unit](https://github.com/akashnayak/go-elasticsearch/workflows/Unit/badge.svg)](https://github.com/akashnayak/go-elasticsearch/actions?query=branch%3Amaster)
[![Integration](https://github.com/akashnayak/go-elasticsearch/workflows/Integration/badge.svg)](https://github.com/akashnayak/go-elasticsearch/actions?query=branch%3Amaster)
[![API](https://github.com/akashnayak/go-elasticsearch/workflows/API/badge.svg)](https://github.com/akashnayak/go-elasticsearch/actions?query=branch%3Amaster)

## Compatibility

The client major versions correspond to the compatible Elasticsearch major versions: to connect to Elasticsearch `7.x`, use a [`7.x`](https://github.com/akashnayak/go-elasticsearch/tree/7.x) version of the client, to connect to Elasticsearch `6.x`, use a [`6.x`](https://github.com/akashnayak/go-elasticsearch/tree/6.x) version of the client.

When using Go modules, include the version in the import path, and specify either an explicit version or a branch:

    require github.com/akashnayak/go-elasticsearch/v7 7.x
    require github.com/akashnayak/go-elasticsearch/v7 7.0.0

It's possible to use multiple versions of the client in a single project:

    // go.mod
    github.com/akashnayak/go-elasticsearch/v6 6.x
    github.com/akashnayak/go-elasticsearch/v7 7.x

    // main.go
    import (
      elasticsearch6 "github.com/akashnayak/go-elasticsearch/v6"
      elasticsearch7 "github.com/akashnayak/go-elasticsearch/v7"
    )
    // ...
...
Or, clone the repository:
    ...
    git clone --branch master https://github.com/akashnayak/go-elasticsearch.git $GOPATH/src/github.com/akashnayak/go-elasticsearch
...
[package documentation](https://godoc.org/github.com/akashnayak/go-elasticsearch/esapi).
